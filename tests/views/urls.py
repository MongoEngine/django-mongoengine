...
urlpatterns = [
    ...
    url(r"^template/simple/(?P<foo>\w+)/$", TemplateView.as_view(template_name="views/about.html")),
    url(
    ...
    url(r"^detail/artist/(?P<pk>\d+)/$", views.ArtistDetail.as_view(), name="artist_detail"),
    url(r"^detail/author/(?P<pk>\d+)/$", views.AuthorDetail.as_view(), name="author_detail"),
    url(
        r"^detail/author/bycustompk/(?P<foo>\d+)/$", views.AuthorDetail.as_view(pk_url_kwarg="foo")
    ),
    ...
    url(r"^edit/author/(?P<pk>\d+)/update/special/$", views.SpecializedAuthorUpdate.as_view()),
    ...
    url(r"^edit/author/(?P<pk>\d+)/delete/special/$", views.SpecializedAuthorDelete.as_view()),
    # ListView
    ...
    url(r"^list/authors/paginated/(?P<page>\d+)/$", views.AuthorList.as_view(paginate_by=30)),
    url(r"^list/authors/notempty/$", views.AuthorList.as_view(allow_empty=False)),
    url(
        r"^list/authors/template_name/$", views.AuthorList.as_view(template_name="views/list.html")
    ),
    url(
    ...
    url(r"^list/authors/paginated/custom_constructor/$", views.AuthorListCustomPaginator.as_view()),
]
