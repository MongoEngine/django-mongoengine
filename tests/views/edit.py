...
class CreateViewTests(ReprComparisonMixin, MongoTestCase):
    ...
    def test_create(self):
        ...
        res = self.client.post(
            "/edit/authors/create/", {"id": 1, "name": "Randall Munroe", "slug": "randall-munroe"}
        )
    ...
    def test_create_invalid(self):
        res = self.client.post(
            "/edit/authors/create/", {"id": 1, "name": "A" * 101, "slug": "randall-munroe"}
        )
        self.assertEqual(res.status_code, 200)
        self.assertTemplateUsed(res, "views/author_form.html")
    ...
    def test_create_with_object_url(self):
        res = self.client.post("/edit/artists/create/", {"id": 1, "name": "Rene Magritte"})
        self.assertEqual(res.status_code, 302)
